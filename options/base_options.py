    ...
    def initialize(self):
        ...
        parser.add_argument('--type_model', type=str, default="DST-GCN",
                            choices=['GraphSAGE', 'FastGCN', 'LADIES', 'ClusterGCN', 'GraphSAINT', 'DST-GCN', 'MLP', 'SGC', 'SIGN', 'SIGN_MLP',
                                     'LP_Adj', 'EdgeSampling', 'GradientSampling', 'SAGN', 'GAMLP', 'Ensembling'])
        ...
        parser.add_argument('--dst_update_rate', type=float, default=0.001, help='initialized dst update rate')
        ...
        parser.add_argument('--dst_update_decay', type=bool, default=True, help='whether to decay update rate')
        parser.add_argument('--dst_update_scheme', type=str, default='node3', help='update schemes')
        parser.add_argument('--dst_grads_scheme', type=int, default=3,
        ...
        parser.add_argument('--GPR_init', type=str, default='PPR',
            choices=['SGC', 'PPR', 'NPPR', 'Random', 'WS', 'Null']) # [0,  1,2,3]
...
def set_labprop_configs(args):
    ...
    if use_default_LP_settings:
        ...
        args.lpStep.fn = [  'double_correlation_fixed',
